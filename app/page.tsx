  ...
  return (
    <main>
      ...
      <section className="venue-band">
        ...
        <div className="venue-cards"><article><a className="venue-photo-link" href="https://www.gasthaus-panholzer.at/" target="_blank" rel="noreferrer"><Image className="venue-photo" src="https://www.gasthaus-panholzer.at/userupload/editorupload/files/files/Pani-Gasthaus-2025.jpg" alt="Gasthaus zur Linde in Kleinraming – Website öffnen" width={900} height={650} /></a><UtensilsCrossed /><span>Nach dem Spiel</span><h3>Gasthaus<br />zur Linde</h3><p>Echte Wirtshausküche und kühle Getränke direkt vor Ort.</p></article><article><a className="venue-photo-link" href="https://www.gasthaus-panholzer.at/de/panis-gaestezimmer.html" target="_blank" rel="noreferrer"><Image className="venue-photo" src="https://www.gasthaus-panholzer.at/userupload/editorupload/files/images/Panis-Gaestezimmer4.jpg" alt="Gemütliches Gästezimmer – Zimmer ansehen" width={900} height={650} /></a><MapPin /><span>Einfach bleiben</span><h3>Pani&apos;s<br />Gästezimmer</h3><p>Fünf gemütlich-moderne Zimmer im selben Haus.</p></article></div>
      </section>
