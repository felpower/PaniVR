  ...
  return (
    <main>
      ...
      <section className="venue-band">
        ...
        <div className="venue-cards"><article><UtensilsCrossed /><span>Nach dem Spiel</span><h3>Gasthaus<br />zur Linde</h3><p>Echte Wirtshausküche und kühle Getränke direkt vor Ort.</p></article><article><MapPin /><span>Einfach bleiben</span><h3>Pani&apos;s<br />Gästezimmer</h3><p>Fünf gemütlich-moderne Zimmer im selben Haus.</p></article></div>
      </section>
